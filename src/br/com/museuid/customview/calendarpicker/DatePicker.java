...
public class DatePicker extends StackPane {
  ...
  private FXCalendar.PickerMode pickerMode;

  public DatePicker(FXCalendar fxCalendar, FXCalendar.PickerMode pickerMode) {
    super();
    ...
    if (pickerMode != FXCalendar.PickerMode.DATE) {
      showTopPane();
    } else {
      showBasePane();
    }
  ...
  public FXCalendar.PickerMode getPickerMode() {
    return pickerMode;
  }

  public void setPickerMode(FXCalendar.PickerMode pickerMode) {
    this.pickerMode = pickerMode;
  }
