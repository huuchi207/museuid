...
//    getChildren().addAll(dateTxtField, popupButton);
  ...
  private void initiatePopUp() {
    if (datePicker == null) {
//      popup.getScene().getStylesheets().add("br/com/museuid/css/calendar_styles.css");
      datePicker = new DatePicker(FXCalendar.this, pickerMode);
