...
public class OrganizacaoController extends AnchorPane {
    ...
    void editar(ActionEvent event) {
        try {
            ...
            NoticeUtils.alert("Selecione um organização na tabela para edição!");
        }
    }
    ...
    void excluir(ActionEvent event) {
        try {
            ...
            DialogUtils.ResponseMessage responseMessage = Messenger.confirm("Excluir organização " + orgao.getNome() + " ?");
            ...
            Messenger.alert("Selecione organização na tabela para exclusão!");
        }
    }
