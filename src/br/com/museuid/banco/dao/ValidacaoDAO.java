...
/**
 * DAO respons�vel pela a��es realizadas na base de dados referentes aos valida��o
 */
public class ValidacaoDAO extends DAO {
    ...
    /**
     * Inserir valida��o na base de dados e retornar seu identificador para cadastro de seus itens
     */
    public int validacao(Validacao validacao) {
        ...
        try {
            ...
            Messenger.erro("Erro ao inserir valida��o na base de dados! \n" + ex);
        }
    ...
    /**
     * Inserir itens da valida��o informado na base de dados
     */
    public void item(int validacao, ValidacaoItem item) {
        try {
            ...
            Messenger.erro("Erro ao inserir item da valida��o na base de dados! \n" + ex);
        }
    }
}
