...
import customview.sectiongridview.ListViewCell;
...
//        apOrderInQueue.getChildren().add(vBox);
        ...
        orderInQueue.setItems(observableList);
        orderInQueue.setCellFactory(new Callback<ListView<String>, ListCell<String>>()
        {
            @Override
